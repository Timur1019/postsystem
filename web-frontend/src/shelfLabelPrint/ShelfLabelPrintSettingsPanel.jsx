  ...
  return (
    <div className="shelflabel-settings rounded-xl border border-slate-200 bg-white p-4 shadow-sm dark:border-slate-700 dark:bg-slate-900">
      ...
      <p className="mt-2 text-sm text-slate-600 dark:text-slate-300">
        {t('usersBarcodePrint.sizePickHint', {
          defaultValue: 'Выберите размер рулона — он должен совпадать с физической лентой и профилем в Windows.',
        })}
      </p>
      ...
      >
        {t('usersBarcodePrint.advancedSettings', { defaultValue: 'Дополнительно' })}
