...
CREATE TABLE service_product_details (
    product_id              UUID PRIMARY KEY REFERENCES products(id) ON DELETE CASCADE,
...
CREATE TABLE z_reports (
    ...
    humo_total              NUMERIC(18, 2) DEFAULT 0,
    uzcard_total            NUMERIC(18, 2) DEFAULT 0,
    cashless_total          NUMERIC(18, 2) DEFAULT 0,
    returns_cash            NUMERIC(18, 2) DEFAULT 0,
    returns_card            NUMERIC(18, 2) DEFAULT 0,
    returns_humo            NUMERIC(18, 2) DEFAULT 0,
    returns_uzcard          NUMERIC(18, 2) DEFAULT 0,
    returns_cashless        NUMERIC(18, 2) DEFAULT 0,
